<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@page import="com.gaire.model.Empleado"%>
	...
	<form action="/web_empleados/empleados/editar/" method="post" >
		...
		<div style="margin-top: 6px;" class="clearfix">
			...
			<div style="float: none;width: auto;overflow: hidden;">
				<input name="id" value="<%= optEmp.get().getId() %>" readonly="readonly"/>
			</div> 
		</div>
		...
		<div style="margin-top: 6px;" class="clearfix">
			...
			<div style="float: none;width: auto;overflow: hidden;">
				<input name="Id_departamento" value="<%= optEmp.get().getId_departamento()%>"/>
			</div> 
		</div>
